...
class ColorBook(object):
    ...
    def preblur(self):
        blur = max(self.xpix, self.ypix) / 300
    ...
    def perform_kmeans(self):
        ...
        im.save("images_colors\colorized_mount.png")
    ...
    def outline_img(self):
        ...
        towrite.save("images_colors\outlined_mount.png")
        ...
        plt.savefig("images_colors\palette_mount.png")
        plt.close()


if __name__ == "__main__":
    colorbook = ColorBook(r'/photo_example/mount.jpg')
